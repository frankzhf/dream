 ...
 *
 */
package net.frank.framework.xml;

/**
 *	<p>Some of the {@link net.frank.framework.writer.ditchnet.jsp.util.JspResponseWriter} class' 
 ...
 *	<p>This class' static inner classes {@link net.frank.framework.xml.ditchnet.xml.Xhtml.Tag}
 *	and {@link net.frank.framework.xml.ditchnet.xml.Xhtml.Attr} present an enumerations of
...
public class Xhtml implements Xml {
	...
	public static class Attr implements Xml.Attr {
		...
		public static final Attr DATATYPE 			= new Attr("data-type");
		public static final Attr TABINDEX 			= new Attr("tabIndex");
		public static final Attr DATATOGGLE 			= new Attr("data-toggle");
		public static final Attr DATATARGET 			= new Attr("data-target");
		public static final Attr DATAREADONLY 			= new Attr("data-readonly");
