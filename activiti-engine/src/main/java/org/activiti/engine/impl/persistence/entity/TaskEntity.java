...
public class TaskEntity extends VariableScopeImpl implements Task, DelegateTask, Serializable, PersistentObject {
  ...
  public void complete(PvmTransition nextTransition){
    ...
    if (executionId!=null) {
      getExecution().take(nextTransition);
    }
  }
  public void complete(String signalName, Object signalData) {
    fireEvent(TaskListener.EVENTNAME_COMPLETE);
    ...
    if (executionId!=null) {
      getExecution().signal(signalName, signalData);
    }
  }
