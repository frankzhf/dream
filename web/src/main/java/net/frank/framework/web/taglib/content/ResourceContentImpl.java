...
public class ResourceContentImpl extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		Resource currResource  = (Resource)var;
		BusinessObject object = currResource.getObject();
		object.setResource(currResource);
		currResource.setObject(null);
		var = object;
