...
public class Signature {
    ...
    private static ObjectMapper parser = new XmlMapper();
     ...
     * @throws SAXException
     */
    public static boolean checkIsSignValidFromResponseString(String key,String responseString) throws IOException {

        Map<String,Object> map = parser.readValue(responseString, HashMap.class);
     ...
     * @return SHA1签名后的结果
     */
    public static String signSHA1(String string) throws NoSuchAlgorithmException, UnsupportedEncodingException {
