...
public final class DedeMemberGroupRender extends BaseEntityTypeRender {
	...
	public void setBodyProperty(BaseEntity targetObject, Node w3cNode) {
		...
		if(propertiesElement!=null && propertiesElement.getLength()>0){
			for(int i=0;i<propertiesElement.getLength();i++){
				...
				}else if(currentElement.getAttributes().getNamedItem(DEFAULT_ATTRIBUTE_NAME).getNodeValue().equals(FIELD_GROUPNAME)){
