...
public class DeviceApHistory implements Serializable {
    private String id;

    private String deviceApId;
    ...
    public void setDeviceApId(String deviceApId) {
        this.deviceApId = deviceApId == null ? null : deviceApId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", deviceApId=").append(deviceApId);
