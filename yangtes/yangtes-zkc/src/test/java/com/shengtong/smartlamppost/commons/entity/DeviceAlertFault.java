...
public class DeviceAlertFault implements Serializable {
    private String id;
    ...
    public String getDeviceAlarmId() {
        return deviceAlarmId;
    }

    public void setDeviceAlarmId(String deviceAlarmId) {
        this.deviceAlarmId = deviceAlarmId == null ? null : deviceAlarmId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", deviceAlarmId=").append(deviceAlarmId);
