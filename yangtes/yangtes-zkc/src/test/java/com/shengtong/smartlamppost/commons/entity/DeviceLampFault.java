...
public class DeviceLampFault implements Serializable {
    private String id;
    ...
    public void setTmlId(String tmlId) {
        this.tmlId = tmlId == null ? null : tmlId.trim();
    }
    ...
    public void setLoopId(String loopId) {
        this.loopId = loopId == null ? null : loopId.trim();
    }
    ...
    public void setFaultSrc(String faultSrc) {
        this.faultSrc = faultSrc == null ? null : faultSrc.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", faultSrc=").append(faultSrc);
