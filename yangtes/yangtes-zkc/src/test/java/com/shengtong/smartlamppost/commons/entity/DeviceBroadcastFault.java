...
public class DeviceBroadcastFault implements Serializable {
    private String id;

    private String branchId;

    private String deviceBroadcastId;
    ...
    public void setDeviceBroadcastId(String deviceBroadcastId) {
        this.deviceBroadcastId = deviceBroadcastId == null ? null : deviceBroadcastId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", deviceBroadcastId=").append(deviceBroadcastId);
