...
public abstract class AbstractGenTool{
	...
	public abstract String getGenTablePrefix();
	...
	protected void generate(){
		...
		for(int i=0;i<tableList.size();i++){
			...
			if(StringUtils.isNotBlank(genTable.getName())
					&& genTable.getName().startsWith(getGenTablePrefix())){
				...
				if(genTable.getColumnList()!=null && 
					...
					try{
						...
						log.error("Generat Error, the table is " + genTable.getDbName(),e);
					}
				}
			}
		}
