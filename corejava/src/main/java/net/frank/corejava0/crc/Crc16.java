package net.frank.corejava0.crc;
...
public final class Crc16 {
	...
	public static void main(String[] args) {
		...
		/***
	     * 0xAA	0x01	0x10	0x0001	0x00查询		0xAA	0xF9B5
	     * 								0x01应答	    		0xF825
	     */
		int crc = Crc16.calcCrc16(new byte[] { 0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00 });
		System.out.println(String.format("0x%04x", crc));
		
		crc = Crc16.calcCrc16(new byte[] { (byte)0xaa, 0x01, 0x10, 0x0001, 0x00, (byte) 0xaa });
		System.out.println(String.format("0x%04x", crc));
		
		crc = Crc16.calcCrc16(new byte[] { (byte)0xaa, 0x01, 0x10, 0x0001, 0x01, (byte) 0xaa });
		System.out.println(String.format("0x%04x", crc));
