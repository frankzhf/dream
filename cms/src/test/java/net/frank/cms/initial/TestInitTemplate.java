...
public final class TestInitTemplate extends TestInitCase {
	...
	public void testInit() {
		...
		Resource respository = createResource("repository", accountTemplate,false,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		res = createResource("myDocument", respository,false,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		...
		res = createResource("published", resK,false,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		res = createResource("recycleBin", respository,false,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		...
		Resource articleTemplate = createResource("article", templateRoot,true,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		res = createResource("image", articleTemplate,true,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
		res = createResource("media", articleTemplate,true,
				getType(CommonConstants.TYPE.RESOURCE), getRootAccount(), getAdminGroup());
	}
}
