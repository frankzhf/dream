...
<div id="north" region="north"
	...
	href="${pageContext.request.contextPath}/<tiles:getAsString name='header'/>"></div>
<div id="west" region="west" border="false" split="true" title="<bean:message key='common.layout.menu'/>"
	style="width: 250px; padding: 5px;"
	href="${pageContext.request.contextPath}/<tiles:getAsString name='menu'/>"></div>
