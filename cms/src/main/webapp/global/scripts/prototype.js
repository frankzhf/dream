...
Ajax.Request.prototype = Object.extend(new Ajax.Base(), {
  ...
  setRequestHeaders: function() {
    ...
    for (var name in headers)
      if (typeof headers[name] != 'function')  // add this line to resolve the conflict when using the json.js
...
function $(element) {
  ...
  //To get the element even if the id attribute is not defined.
  if (Object.isString(element)){
    var e = document.getElementById(element);
  	if((e == undefined || e == null) && element != ''){
  		var e2 = document.getElementsByName(element);
  		if(e2 != undefined && e2 != null && e2.length > 0){
  			element = e2[0];
  		} else{
  			element = e;
  		}
