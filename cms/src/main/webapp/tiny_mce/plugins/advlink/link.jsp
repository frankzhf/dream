...
<body id="advlink" style="display: none" role="application" onload="javascript:mcTabs.displayTab('navigate_tab','navigate_panel', true);" aria-labelledby="app_label">
	<span class="mceVoiceLabel" id="app_label" style="display:none;">{#advlink_dlg.title}</span>
	<form onsubmit="insertAction();return false;" action="#">
		<div class="tabs" role="presentation">
			<ul>
				<li id="navigate_tab" class="current" aria-controls="navigate_panel"><span><a href="javascript:mcTabs.displayTab('navigate_tab','navigate_panel');" onmousedown="return false;">{#advlink_dlg.navigate_tab}</a></span></li>
				<li id="general_tab" aria-controls="general_panel" ><span><a href="javascript:mcTabs.displayTab('general_tab','general_panel');" onmousedown="return false;">{#advlink_dlg.general_tab}</a></span></li>
		...
		<div class="panel_wrapper" role="presentation">
			<div id="navigate_panel" class="panel current">
				<fieldset>
					<legend>{#advlink_dlg.document_navigation}</legend>
