...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/global/scripts/jquery/jquery-1.7.1.js"></script>
			...
			<div id="general_panel" class="panel current">
				<table>
					...
					<fieldset>
						...
						<input name="src" type="hidden" id="src" value="" aria-required="true" />
