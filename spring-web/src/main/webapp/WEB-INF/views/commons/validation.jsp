...
<script type="text/javascript">
	...
	vld.ERR_MSGS["Mandatory"] = '<spring:message code="common.validator.error.message.mandatory" /> {0}';
	vld.ERR_MSGS["Number"] = '<spring:message code="common.validator.error.message.number" /> {0}';
	vld.ERR_MSGS["Decimal"] = '<spring:message code="common.validator.error.message.decimal" /> {0}';
	vld.ERR_MSGS["Email"] = '<spring:message code="common.validator.error.message.email" /> {0}';
	vld.ERR_MSGS["Phone"] = '<spring:message code="common.validator.error.message.phone" /> {0}';
	vld.ERR_MSGS["Mobile"] = '<spring:message code="common.validator.error.message.mobile" /> {0}';	
	vld.ERR_MSGS["Date"] = '<spring:message code="common.validator.error.message.date" /> {0} <spring:message code="common.validator.error.message.date.help" />';
	vld.ERR_MSGS["Money"] = '<spring:message code="common.validator.error.message.money" />  {0}';
	vld.ERR_MSGS["Year"] = '<spring:message code="common.validator.error.message.year" />  {0}';
	vld.ERR_MSGS["24Time"] = '<spring:message code="common.validator.error.message.time.12" />  {0} <spring:message code="common.validator.error.message.time.12.help" />';
	vld.ERR_MSGS["12Time"] = '<spring:message code="common.validator.error.message.time.24" />  {0} <spring:message code="common.validator.error.message.time.24.help" />';
	...
	vld.Validation.prototype = {
		...
		alertErrMsg : function(errMsg, errorType) {
			if (errMsg.length > 0) {
				for(var i=0;i<this.errArray.length;i++){
					var errorObj = this.errArray[i];
					$("#"+errorObj.fieldName+"Error").addClass("alert alert-error");
					$("#"+errorObj.fieldName+"Error").html(vld.ERR_MSGS[errorObj.errorType].replace(
							vld.AGR_EXP, errorObj.labelCtx));
				}
				$("#"+this.errArray[0].fieldName).focus();
				/***
