...
$(function() {
	...
	$("#myDrafts").window("refresh","${pageContext.request.contextPath}/tasklist/myDrafts.do");
	$("#pendingTasks").window("refresh","${pageContext.request.contextPath}/tasklist/pendingTasks.do");
	$("#myUnits").window("refresh","${pageContext.request.contextPath}/tasklist/myUnits.do");
	$("#myTasks").window("refresh","${pageContext.request.contextPath}/tasklist/myTasks.do");
